...
7. Completa solamente el perfil nuevo creado por esta misión con fuentes observadas, referencias a artefactos existentes y restricciones necesarias; usa escritura segura y conserva contenido si ya existía. No transformes antecedentes en observaciones vigentes. El primer encargo de auditoría/reparación sigue pendiente de mandato propio.
8. Repite la inicialización compatible y comprueba que el perfil completado no cambia. Verifica estado final del framework y del producto; cualquier diferencia nueva debe explicarse, no descartarse para aparentar limpieza.
