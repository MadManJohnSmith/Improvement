...
| 4 | Handoff determinista Auditor→Reparación | PARCIAL | `Publisher.open_batch/publish_batch_record/close_batch`, `handoff/resolve_handoff`; entrega local completa/parcial verificada | Resolución Host, autorización de roles y continuación persistente |
