...
| 7 | Controlador Host y recuperación ante fallos | PARCIAL | `scripts/host_controller.py` implementado (mandato, cola, locks, presupuesto durable, reconciliación idempotente, cancelación; 7 tests con fake determinista) + suite de recuperación + caída real del rig | Ensayo real del controlador conduciendo unidades de M1; descendientes remotos y pérdida de energía |
