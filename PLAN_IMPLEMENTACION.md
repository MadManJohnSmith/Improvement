...
| 4 | Handoff determinista Auditor→Reparación | PARCIAL | `Publisher.handoff/resolve_handoff`; formato local y proceso separado verificados | Resolución Host, autorización de roles y entrega multi-registro |
