...
| 4 | Handoff determinista Auditor→Reparación | PARCIAL | Lotes locales + estados `executor/qa/auditor`; aceptación bloqueada sin QA `VERIFIED` | Resolución Host, independencia real de QA y continuación persistente |
