...
| 4 | Handoff determinista Auditor→Reparación | PARCIAL | `Publisher.open_batch/publish_batch_record/close_batch`, `handoff/resolve_handoff`; cierre idempotente, referencias y entrega completa/parcial verificadas | Resolución Host, autorización de roles y continuación persistente |
